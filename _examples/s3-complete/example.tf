...
module "vpc" {
  source      = "git::git@github.com:navneetbishnoi/terraform-aws-vpc?ref=v1.0.4"
  name        = "app"
  environment = local.environment
...
module "subnets" {
  source             = "git::ssh://git@github.com/navneetbishnoi/terraform-aws-subnet?ref=v1.0.4"
...
module "kms_key" {
  source                  = "git::ssh://git@github.com/navneetbishnoi/terraform-aws-kms?ref=v1.0.4"
  name                    = "kms11"
  environment             = local.environment
  label_order             = local.label_order
  enabled                 = true
